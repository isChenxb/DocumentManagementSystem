...
<body>
	...
	<div class="easyui-panel" title="公文登记" style="width:100%;max-width:400px;padding:30px 60px;">
		<form id="ff" method="post" action="logOuterDocAction" enctype="multipart/form-data">
		    <div style="margin-bottom:20px">
				<input class="easyui-textbox" name="doc_id" style="width:100%" data-options="label:'公文编号：',required:true">
			</div>
			<div style="margin-bottom:20px">
				<input class="easyui-textbox" name="doc_name" style="width:100%" data-options="label:'公文名称：',required:true">
			</div>
			<div style="margin-bottom:20px">
				<input class="easyui-textbox" name="from_dep" style="width:100%" data-options="label:'来文单位：',required:true">
			</div>
			<div style="margin-bottom:20px">
